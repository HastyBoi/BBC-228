...
//}
//
//std::vector<TTM::LexTable::Entry> convert(std::vector<TTM::LexTable::Entry> entries) {
//	std::vector<TTM::LexTable::Entry> output;
//	std::stack<TTM::LexTable::Entry> stack;
//
//	for (int i = 0; entries[i].lexeme != LEX_SEMICOLON; ++i) {
//		const TTM::LexTable::Entry& entry = entries[i];
//
...
//	std::vector<TTM::LexTable::Entry> infixExpressionEntries;
...
//			TTM::LexTable::Entry tmp = TTMGetEntry(lextable, i);
//			tmp.lexeme = LEX_FN;
...
//		}
//		else {
//			infixExpressionEntries.push_back(TTMGetEntry(lextable, i));
//
//			if (lexeme == LEX_COMMA)
//				operandsCounter--;
//		}
...
//		return false;
//
//	std::vector<TTM::LexTable::Entry> postfixExpressionEntries = convert(infixExpressionEntries);
