...
//void LA::Scan(LT::LexTable& lextable, IT::IdTable& idtable, TTM::IN& in, const char* outFilePath, Log::Logger& log) {
...
//		if (in.code[ch] == TTM::IN::T) {
//			accumulator += ch;
//		}
//		else if (in.code[ch] == TTM::IN::Q) {
//			do {
//				accumulator += ch;
//				i++;
//				ch = in.text[i];
//			} while (in.code[ch] != TTM::IN::Q);
//			accumulator += ch;
//			fillTables();
//		}
//		else if (in.code[ch] == TTM::IN::S || in.code[ch] == TTM::IN::O || ch == TTM::IN_CODE_DELIM) {
//			if (!accumulator.empty()) {
//				fillTables();
//			}
//			if (in.code[ch] == TTM::IN::O) {
//				accumulator = ch;
//				fillTables();
//			}
//		}
//
//		if (ch == TTM::IN_CODE_DELIM) {
//			line++;
//			if (in.text[i + 1]) {
